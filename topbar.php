  ...
  <div class="container">
    <ul class="navbar-nav">
      ...
      <li>
        <a class="nav-link text-white" href="./" role="button">
          <large><b>Online Jewelry Shop</b></large>
        </a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <?php else: ?>
        ...
        <li class="nav-item">
          <a class="nav-link nav-login" href="index.php?page=my_req" id="login">
            <b>My Requests</b>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link nav-login" href="index.php?page=my_collection" id="login">
            <b>My Collections</b>
          </a>
        </li>
