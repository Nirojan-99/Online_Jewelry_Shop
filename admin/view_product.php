    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-12 col-sm-6">
          ...
          <p>In Stock: <span style="background-color: green; color: white; padding: 5px 10px; border-radius: 10px; font-size: 12px;margin-left: 10px;"><?php echo ucwords($available_in_store) ?></span></p>
