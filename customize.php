            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <div class="w-100 my-3">
                        <div class="form-label mb-1">Customization Requests</div>
                        <textarea  id="cus_req" type="text" class="w-100  form-control"></textarea>
                    </div>
                    <div class="w-100 my-3">
                        <div class="form-label mb-1">Delivery Address</div>
                        <textarea  id="delivery_address" type="text" class="w-100  form-control"></textarea>
                    </div>
                    <div class="btn btn-primary btn-lg btn-flat " id="send_request">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#send_request').click(function() {
                ...
                $.ajax({
                    url: 'admin/ajax.php?action=custom_req',
                    method: 'POST',
                    data: {
                    ...
                    success: function(resp) {
                        if (resp == 1) {
                            alert_toast("Customization request send successfully", "success")
                            end_load()
                            load_cart()
                        }
                    }
